...
function NavBar() {
  return (
    <nav className="w-full h-16 flex flex-row justify-between items-center p-4 fixed top-0 left-0 h-4 bg-white">
      <div className="flex flex-row text-gray-400 justify-center items-center">
        <div>
          <svg
      ...
      <div className="">
        <button type="button" className="block text-gray-400 md:hidden">
        ...
        {/* TODO: Show nav items in desktop view */}
